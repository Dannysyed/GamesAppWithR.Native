...
const GuessGame = ({ navigation }) => {
    let Games = [{ id: '1', GameName: 'Guess the game' }, { id: '2', GameName: "PigGame" }, { id: '2', GameName: "PigGame" }, { id: '2', GameName: "PigGame" }, { id: '2', GameName: "PigGame" }]
